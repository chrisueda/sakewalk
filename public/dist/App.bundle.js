...
function autocomplete(input, latInput, lngInput) {
  ...
  // don't submit on enter on address field
...
function loadPlaces(map) {
  ...
  _axios2.default.get("/api/locations/near?lat=" + lat + "&lng=" + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener("click", function () {
        var html = "\n        <div class=\"popup\">\n          <a href=\"/location/" + this.place.slug + "\">\n            <img src=\"/uploads/" + (this.place.photo || "location.png") + "\" alt=\"" + this.place.name + "\"/>\n            <p>" + this.place.name + " - " + this.place.location.address + "</p>\n          </a>\n        </div>\n      ";
...
function searchResultsHTML(locations) {
  return locations.map(function (location) {
    return "\n      <a href=\"/location/" + location.slug + "\" class=\"search__result\">" + location.name + "</a>\n    ";
  }).join("");
}
